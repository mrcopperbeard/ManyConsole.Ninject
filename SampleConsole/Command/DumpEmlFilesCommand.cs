...
{
	public class DumpEmlFilesCommand : ConsoleCommand, IConsoleCommand
	{
		public DumpEmlFilesCommand()
		{
			IsCommand("dump-eml", "Prints the contents of eml file(s).");

			HasOption("r|recursive", "Print files recursively", v => Recursive = v != null);
			HasOption("h|header=", "Mail header to include", v => HeadersToPrint.Add(v));
